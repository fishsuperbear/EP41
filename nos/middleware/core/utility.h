#ifndef NETAOS_CORE_UTILITY_H
#define NETAOS_CORE_UTILITY_H
...
template <typename T>
struct is_inplace_type_impl : public std::false_type {};
template <typename T>
...
template <typename T>
struct is_inplace_index_impl : public std::false_type {};
template <size_t I>
