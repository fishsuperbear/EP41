 ...
 * Description:  Class DocanTaskEvent Header
 */
...
namespace diag {
    ...
    /**
     * @brief class DocanTaskEvent
     *
     */
    class DocanTaskEvent : public STEvent
    {
    public:
        DocanTaskEvent(uint32_t evtKind, uint32_t evtId, int32_t evtVal1, int32_t evtVal2, const std::vector<uint8_t>& evtData);
        virtual ~DocanTaskEvent();
    ...
    private:
        DocanTaskEvent(const DocanTaskEvent&);
        DocanTaskEvent& operator=(const DocanTaskEvent&);
