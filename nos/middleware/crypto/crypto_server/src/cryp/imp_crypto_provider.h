...
namespace crypto {
namespace cryp {
class ImpCryptoProvider:public CryptoProvider {
public:
    ...
    // static ImpCryptoProvider& Instance();
...
private:
    // static ImpCryptoProvider *instance_;
    static std::mutex instance_mutex_;
    // ImpCryptoProvider();
    // ~ImpCryptoProvider() noexcept;
    // ImpCryptoProvider(const ImpCryptoProvider&) = delete;
    // ImpCryptoProvider& operator=(const ImpCryptoProvider&) = delete;
    // ImpCryptoProvider(const ImpCryptoProvider&&) = delete;
    // ImpCryptoProvider& operator=(const ImpCryptoProvider&&) = delete;
    ...
    int getCipherKeyLength(AlgId algId);
