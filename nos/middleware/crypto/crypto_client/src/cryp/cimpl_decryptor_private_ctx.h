...
namespace crypto {
namespace cryp {
class CimpDecryptorPrivateCtx:public DecryptorPrivateCtx {
public:
    using Uptr = std::unique_ptr<CimpDecryptorPrivateCtx>;
    CimpDecryptorPrivateCtx(const CipherCtxRef& ctx_ref);
    ~CimpDecryptorPrivateCtx();
