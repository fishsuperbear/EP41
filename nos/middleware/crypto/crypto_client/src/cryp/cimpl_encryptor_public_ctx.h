...
namespace crypto {
namespace cryp {
class CimplEncryptorPublicCtx:public EncryptorPublicCtx {
public:
    using Uptr = std::unique_ptr<CimplEncryptorPublicCtx>;
    CimplEncryptorPublicCtx(const CipherCtxRef& ctx_ref);
    ~CimplEncryptorPublicCtx();
