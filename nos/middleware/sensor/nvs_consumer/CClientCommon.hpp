...
#include "sensor/nvs_consumer/Common.hpp"
#include "sensor/nvs_consumer/CEventHandler.hpp"
#include "sensor/nvs_consumer/CProfiler.hpp"
...
typedef struct
{
    ...
    uint64_t captureImgTimestamp;
    uint32_t streamImageCount;
} MetaData;
...
class CClientCommon : public CEventHandler
{
    ...
    protected:
        ...
        virtual SIPLStatus OnDataBufAttrListReceived(NvSciBufAttrList bufAttrList) {return NVSIPL_STATUS_OK;};
