...
#ifndef HOZON_SOC2MCU_IMPL_TYPE_ADAS_DATARECORDFRAME_SOC_H
#define HOZON_SOC2MCU_IMPL_TYPE_ADAS_DATARECORDFRAME_SOC_H
#include <cfloat>
#include <cmath>
...
namespace hozon {
namespace soc2mcu {
struct ADAS_DataRecordFrame_soc {
    ...
    bool operator==(const ::hozon::soc2mcu::ADAS_DataRecordFrame_soc& t) const
    {
        return (pFCT_FctEEPromInfo == t.pFCT_FctEEPromInfo) && (pAdptrOut_Adptr_Out == t.pAdptrOut_Adptr_Out) && (pCtrl_CtrlEEPromInfo == t.pCtrl_CtrlEEPromInfo) && (rAdptrOut_HafChassisInfo == t.rAdptrOut_HafChassisInfo) && (rCtrl_GlobalTime == t.rCtrl_GlobalTime) && (rAdptrIn_MCU == t.rAdptrIn_MCU) && (rAdptrIn_VEH_CAN == t.rAdptrIn_VEH_CAN) && (header == t.header);
    }
};
} // namespace soc2mcu
} // namespace hozon
...
#endif // HOZON_SOC2MCU_IMPL_TYPE_ADAS_DATARECORDFRAME_SOC_H
