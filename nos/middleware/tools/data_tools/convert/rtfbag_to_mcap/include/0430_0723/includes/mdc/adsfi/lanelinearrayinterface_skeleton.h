...
private:
    ...
    void ConstructSkeleton(const ara::com::MethodCallProcessingMode mode)
    {
        ...
        const ara::core::Result<void> resultLaneLineArrayEvent = skeletonAdapter->InitializeEvent(LaneLineArrayEvent);
...
public:
    ...
    explicit LaneLineArrayInterfaceSkeleton(const ara::com::InstanceIdentifier& instanceId,
        ...
        : skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::mdc::adsfi::LaneLineArrayInterface::ServiceIdentifier, instanceId, mode)),
          LaneLineArrayEvent(skeletonAdapter->GetSkeleton(), events::LaneLineArrayInterfaceLaneLineArrayEventId){
        ...
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter>& preSkeletonAdapter, const ara::com::MethodCallProcessingMode mode)
    {
        ...
        do {
            ...
            const events::LaneLineArrayEvent LaneLineArrayEvent(preSkeletonAdapter->GetSkeleton(), events::LaneLineArrayInterfaceLaneLineArrayEventId);
