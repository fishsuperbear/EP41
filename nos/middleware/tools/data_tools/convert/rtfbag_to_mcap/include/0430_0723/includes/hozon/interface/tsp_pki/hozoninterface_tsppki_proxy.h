...
static constexpr ara::com::internal::EntityId HozonInterface_TspPkiRequestHttpsId = 61636U; //RequestHttps_method_hash
...
class RequestHttps {
public:
    using Output = hozon::interface::tsp_pki::methods::RequestHttps::Output;

    RequestHttps(const std::shared_ptr<vrtf::vcc::Proxy>& proxy, const ara::com::internal::EntityId entityId): method_(proxy, entityId){}
    void Initialize(const std::shared_ptr<vrtf::vcc::Proxy>& proxy, const ara::com::internal::EntityId entityId)
    {
        method_.Initialize(proxy, entityId);
    }
    ara::core::Future<Output> operator()(const ::hozon::tsp_pki::RequestHttpsParam& HttpsParam)
    {
        return method_(HttpsParam);
    }

    ara::com::internal::proxy::method::MethodAdapter<Output, ::hozon::tsp_pki::RequestHttpsParam> GetMethod() const
    {
        return method_;
    }
...
private:
    ara::com::internal::proxy::method::MethodAdapter<Output, ::hozon::tsp_pki::RequestHttpsParam> method_;
};
} // namespace methods
...
public:
    ...
    explicit HozonInterface_TspPkiProxy(const vrtf::vcc::api::types::HandleType &handle)
        : proxyAdapter(std::make_unique<ara::com::internal::proxy::ProxyAdapter>(::hozon::interface::tsp_pki::HozonInterface_TspPki::ServiceIdentifier, handle)),
          ...
          RequestHttps(proxyAdapter->GetProxy(), methods::HozonInterface_TspPkiRequestHttpsId){
            ...
            ara::core::Result<void> resultRequestHttps = proxyAdapter->InitializeMethod<methods::RequestHttps::Output>(methods::HozonInterface_TspPkiRequestHttpsId);
            ThrowError(resultRequestHttps);
        }
        ...
        const vrtf::vcc::api::types::HandleType &handle)
    {
        ...
        do {
            ...
            const methods::RequestHttps RequestHttps(preProxyAdapter->GetProxy(), methods::HozonInterface_TspPkiRequestHttpsId);
            initResult = preProxyAdapter->InitializeMethod<methods::RequestHttps::Output>(methods::HozonInterface_TspPkiRequestHttpsId);
            if (!initResult.HasValue()) {
                result = false;
                break;
            }
    ...
    methods::RequestHttps RequestHttps;
};
} // namespace proxy
} // namespace tsp_pki
} // namespace interface
