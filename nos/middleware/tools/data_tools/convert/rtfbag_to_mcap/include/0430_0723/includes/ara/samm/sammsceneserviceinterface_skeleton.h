...
private:
    ...
    void ConstructSkeleton(const ara::com::MethodCallProcessingMode mode)
    {
        ...
        const ara::core::Result<void> resultSammSceneEvent = skeletonAdapter->InitializeEvent(SammSceneEvent);
...
public:
    ...
    explicit SammSceneServiceInterfaceSkeleton(const ara::com::InstanceIdentifier& instanceId,
        ...
        : skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::ara::samm::SammSceneServiceInterface::ServiceIdentifier, instanceId, mode)),
          SammSceneEvent(skeletonAdapter->GetSkeleton(), events::SammSceneServiceInterfaceSammSceneEventId){
        ...
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter>& preSkeletonAdapter, const ara::com::MethodCallProcessingMode mode)
    {
        ...
        do {
            ...
            const events::SammSceneEvent SammSceneEvent(preSkeletonAdapter->GetSkeleton(), events::SammSceneServiceInterfaceSammSceneEventId);
