...
#ifndef HOZON_SENSORS_IMPL_TYPE_RAWPOINTCLOUDFRAME_H
#define HOZON_SENSORS_IMPL_TYPE_RAWPOINTCLOUDFRAME_H
#include <cfloat>
#include <cmath>
#include "hozon/common/impl_type_commonheader.h"
#include "impl_type_uint32.h"
#include "hozon/sensors/impl_type_rawpointfields.h"
...
struct RawPointCloudFrame {
    ...
    ::UInt32 rowStep;
    ::UInt32 isDense;
    ::hozon::sensors::RawPointFields data;
    ...
    bool operator==(const ::hozon::sensors::RawPointCloudFrame& t) const
    {
...
#endif // HOZON_SENSORS_IMPL_TYPE_RAWPOINTCLOUDFRAME_H
