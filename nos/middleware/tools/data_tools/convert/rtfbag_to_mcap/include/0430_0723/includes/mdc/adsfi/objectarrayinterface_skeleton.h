...
private:
    ...
    void ConstructSkeleton(const ara::com::MethodCallProcessingMode mode)
    {
        ...
        const ara::core::Result<void> resultObjectArrayEvent = skeletonAdapter->InitializeEvent(ObjectArrayEvent);
...
public:
    ...
    explicit ObjectArrayInterfaceSkeleton(const ara::com::InstanceIdentifier& instanceId,
        ...
        : skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::mdc::adsfi::ObjectArrayInterface::ServiceIdentifier, instanceId, mode)),
          ObjectArrayEvent(skeletonAdapter->GetSkeleton(), events::ObjectArrayInterfaceObjectArrayEventId){
        ...
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter>& preSkeletonAdapter, const ara::com::MethodCallProcessingMode mode)
    {
        ...
        do {
            ...
            const events::ObjectArrayEvent ObjectArrayEvent(preSkeletonAdapter->GetSkeleton(), events::ObjectArrayInterfaceObjectArrayEventId);
