...
#ifndef HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_HAFCOMDATAFLTINFO_H
#define HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_HAFCOMDATAFLTINFO_H
#include <cfloat>
#include <cmath>
...
struct DtDebug_HafcomDataFltInfo {
    ...
    bool operator==(const ::hozon::soc_mcu::DtDebug_HafcomDataFltInfo& t) const
    {
...
#endif // HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_HAFCOMDATAFLTINFO_H
