...
#include "hozon/tsp_pki/impl_type_requesthttpsparam.h"
#include "hozon/tsp_pki/impl_type_responsehttps.h"
#include <cfloat>
#include <cmath>
...
namespace RequestHttps {
struct Output {
    ::hozon::tsp_pki::ResponseHttps HttpsResponse;
    ...
    bool operator==(const Output& t) const
    {
       return (HttpsResponse == t.HttpsResponse);
    }
};
} // namespace RequestHttps
} // namespace methods
