...
namespace methods
{
    ...
    using RequestHttpsHandle = ara::com::internal::skeleton::method::MethodAdapter;
...
private:
    ...
    void ConstructSkeleton(const ara::com::MethodCallProcessingMode mode)
    {
        ...
        const ara::core::Result<void> resultRequestHttps = skeletonAdapter->InitializeMethod<ara::core::Future<RequestHttpsOutput>>(methods::HozonInterface_TspPkiRequestHttpsId);
...
public:
    ...
    using RequestHttpsOutput = hozon::interface::tsp_pki::methods::RequestHttps::Output;
    ...
    explicit HozonInterface_TspPkiSkeleton(const ara::com::InstanceIdentifier& instanceId,
        ...
        : skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::hozon::interface::tsp_pki::HozonInterface_TspPki::ServiceIdentifier, instanceId, mode)),
          ...
          RequestHttpsHandle(skeletonAdapter->GetSkeleton(), methods::HozonInterface_TspPkiRequestHttpsId){
        ...
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter>& preSkeletonAdapter, const ara::com::MethodCallProcessingMode mode)
    {
        ...
        do {
            ...
            initResult = preSkeletonAdapter->InitializeMethod<ara::core::Future<RequestHttpsOutput>>(methods::HozonInterface_TspPkiRequestHttpsId);
            if (!initResult.HasValue()) {
                result = false;
                break;
            }
    ...
    void OfferService()
    {
        ...
        skeletonAdapter->RegisterMethod(&HozonInterface_TspPkiSkeleton::RequestHttps, *this, methods::HozonInterface_TspPkiRequestHttpsId);
    ...
    virtual ara::core::Future<RequestHttpsOutput> RequestHttps(const ::hozon::tsp_pki::RequestHttpsParam& HttpsParam) = 0;
    ...
    methods::RequestHttpsHandle RequestHttpsHandle;
};
} // namespace skeleton
} // namespace tsp_pki
} // namespace interface
