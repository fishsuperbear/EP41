...
#ifndef HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_SOADATA_H
#define HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_SOADATA_H
#include <cfloat>
#include <cmath>
...
struct DtDebug_SOAData {
    ...
    bool operator==(const ::hozon::soc_mcu::DtDebug_SOAData& t) const
    {
...
#endif // HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_SOADATA_H
