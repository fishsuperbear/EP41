...
#ifndef HOZON_AVPMAPMSG_IMPL_TYPE_LANEPARAM_H
#define HOZON_AVPMAPMSG_IMPL_TYPE_LANEPARAM_H
#include <cfloat>
#include <cmath>
...
struct LaneParam {
    ...
    bool operator==(const ::hozon::avpmapmsg::LaneParam& t) const
    {
...
#endif // HOZON_AVPMAPMSG_IMPL_TYPE_LANEPARAM_H
