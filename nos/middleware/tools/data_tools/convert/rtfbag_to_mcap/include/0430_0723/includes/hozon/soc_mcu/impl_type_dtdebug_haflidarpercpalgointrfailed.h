...
#ifndef HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_HAFLIDARPERCPALGOINTRFAILED_H
#define HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_HAFLIDARPERCPALGOINTRFAILED_H
#include <cfloat>
#include <cmath>
...
struct DtDebug_HafLidarPercpAlgoIntrFailed {
    ...
    bool operator==(const ::hozon::soc_mcu::DtDebug_HafLidarPercpAlgoIntrFailed& t) const
    {
...
#endif // HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_HAFLIDARPERCPALGOINTRFAILED_H
