...
private:
    ...
    void ConstructSkeleton(const ara::com::MethodCallProcessingMode mode)
    {
        ...
        const ara::core::Result<void> resultNavigationResultEvent = skeletonAdapter->InitializeEvent(NavigationResultEvent);
...
public:
    ...
    explicit NavigationResultServiceInterfaceSkeleton(const ara::com::InstanceIdentifier& instanceId,
        ...
        : skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::mdc::navigation::NavigationResultServiceInterface::ServiceIdentifier, instanceId, mode)),
          NavigationResultEvent(skeletonAdapter->GetSkeleton(), events::NavigationResultServiceInterfaceNavigationResultEventId){
        ...
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter>& preSkeletonAdapter, const ara::com::MethodCallProcessingMode mode)
    {
        ...
        do {
            ...
            const events::NavigationResultEvent NavigationResultEvent(preSkeletonAdapter->GetSkeleton(), events::NavigationResultServiceInterfaceNavigationResultEventId);
