...
private:
    ...
    void ConstructSkeleton(const ara::com::MethodCallProcessingMode mode)
    {
        ...
        const ara::core::Result<void> resultCrossValidateArray = skeletonAdapter->InitializeEvent(CrossValidateArray);
...
public:
    ...
    explicit CrossValidateArrayIntfSkeleton(const ara::com::InstanceIdentifier& instanceId,
        ...
        : skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::sotif::CrossValidateArrayIntf::ServiceIdentifier, instanceId, mode)),
          CrossValidateArray(skeletonAdapter->GetSkeleton(), events::CrossValidateArrayIntfCrossValidateArrayId){
        ...
        const ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    {
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter> preSkeletonAdapter =
            std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(
                ::sotif::CrossValidateArrayIntf::ServiceIdentifier, instanceId, mode);
        ...
        const ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    {
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter> preSkeletonAdapter =
            std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(
                ::sotif::CrossValidateArrayIntf::ServiceIdentifier, instanceSpec, mode);
        return PreConstructResult(preSkeletonAdapter, mode);
    }
        ...
        const ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    {
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter> preSkeletonAdapter =
            std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(
                ::sotif::CrossValidateArrayIntf::ServiceIdentifier, instanceIdContainer, mode);
        return PreConstructResult(preSkeletonAdapter, mode);
    }
        ...
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter>& preSkeletonAdapter, const ara::com::MethodCallProcessingMode mode)
    {
        ...
        do {
            ...
            const events::CrossValidateArray CrossValidateArray(preSkeletonAdapter->GetSkeleton(), events::CrossValidateArrayIntfCrossValidateArrayId);
            initResult = preSkeletonAdapter->InitializeEvent(CrossValidateArray);
