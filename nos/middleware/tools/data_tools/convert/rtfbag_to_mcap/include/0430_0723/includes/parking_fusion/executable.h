...
#ifndef PARKING_FUSION_EXECUTABLE_H
#define PARKING_FUSION_EXECUTABLE_H

#include "hozon/interface/avp_map/hozoninterface_avp_map_proxy.h"
...
#endif // PARKING_FUSION_EXECUTABLE_H
