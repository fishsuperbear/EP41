...
#ifndef HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_HAFLIDARPERCPDATAFAILED_H
#define HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_HAFLIDARPERCPDATAFAILED_H
#include <cfloat>
#include <cmath>
...
struct DtDebug_HafLidarPercpDataFailed {
    ...
    bool operator==(const ::hozon::soc_mcu::DtDebug_HafLidarPercpDataFailed& t) const
    {
...
#endif // HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_HAFLIDARPERCPDATAFAILED_H
