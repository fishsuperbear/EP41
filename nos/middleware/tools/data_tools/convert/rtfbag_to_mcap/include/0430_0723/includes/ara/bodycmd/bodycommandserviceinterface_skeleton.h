...
namespace events
{
    ...
    static constexpr ara::com::internal::EntityId BodyCommandServiceInterfacemdcEventId = 10488U; //mdcEvent_event_hash
}
...
public:
    ...
    explicit BodyCommandServiceInterfaceSkeleton(const ara::com::InstanceIdentifier& instanceId,
        ...
        : skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::ara::bodycmd::BodyCommandServiceInterface::ServiceIdentifier, instanceId, mode)),
          mdcEvent(skeletonAdapter->GetSkeleton(), events::BodyCommandServiceInterfacemdcEventId){
        ...
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter>& preSkeletonAdapter, const ara::com::MethodCallProcessingMode mode)
    {
        ...
        do {
            ...
            const events::mdcEvent mdcEvent(preSkeletonAdapter->GetSkeleton(), events::BodyCommandServiceInterfacemdcEventId);
