...
struct ObjectFusion {
    ...
    ::UInt32 age;
    ::hozon::composite::FloatArray9 velocity_uncertainty;
    ::hozon::composite::FloatArray9 acceleration_uncertainty;
    ::UInt8 isOccluded;
    ::Float occludedProb;
    ::UInt8 isTruncated;
    ::Float truncatedProb;
    ...
    void enumerate(F& fun)
    {
        ...
        fun(associatedConf);
        fun(age);
        fun(velocity_uncertainty);
        fun(acceleration_uncertainty);
        fun(isOccluded);
        fun(occludedProb);
        fun(isTruncated);
        fun(truncatedProb);
    ...
    void enumerate_internal(F& fun)
    {
        ...
        fun("age", age);
        fun("velocity_uncertainty", velocity_uncertainty);
        fun("acceleration_uncertainty", acceleration_uncertainty);
