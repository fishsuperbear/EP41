...
#ifndef HOZON_SOC_MCU_IMPL_TYPE_DTCLOUD_HAFPROCSSOCALIVEFLTINFO_H
#define HOZON_SOC_MCU_IMPL_TYPE_DTCLOUD_HAFPROCSSOCALIVEFLTINFO_H
#include <cfloat>
#include <cmath>
...
struct DtCloud_HafprocsSocAliveFltInfo {
    ...
    bool operator==(const ::hozon::soc_mcu::DtCloud_HafprocsSocAliveFltInfo& t) const
    {
...
#endif // HOZON_SOC_MCU_IMPL_TYPE_DTCLOUD_HAFPROCSSOCALIVEFLTINFO_H
