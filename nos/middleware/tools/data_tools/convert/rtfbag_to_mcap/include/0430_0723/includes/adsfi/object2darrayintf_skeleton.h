...
private:
    ...
    void ConstructSkeleton(const ara::com::MethodCallProcessingMode mode)
    {
        ...
        const ara::core::Result<void> resultObject2dArray = skeletonAdapter->InitializeEvent(Object2dArray);
...
public:
    ...
    explicit Object2dArrayIntfSkeleton(const ara::com::InstanceIdentifier& instanceId,
        ...
        : skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::adsfi::Object2dArrayIntf::ServiceIdentifier, instanceId, mode)),
          Object2dArray(skeletonAdapter->GetSkeleton(), events::Object2dArrayIntfObject2dArrayId){
        ...
        const ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    {
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter> preSkeletonAdapter =
            std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(
                ::adsfi::Object2dArrayIntf::ServiceIdentifier, instanceId, mode);
        ...
        const ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    {
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter> preSkeletonAdapter =
            std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(
                ::adsfi::Object2dArrayIntf::ServiceIdentifier, instanceSpec, mode);
        return PreConstructResult(preSkeletonAdapter, mode);
    }
        ...
        const ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    {
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter> preSkeletonAdapter =
            std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(
                ::adsfi::Object2dArrayIntf::ServiceIdentifier, instanceIdContainer, mode);
        return PreConstructResult(preSkeletonAdapter, mode);
    }
        ...
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter>& preSkeletonAdapter, const ara::com::MethodCallProcessingMode mode)
    {
        ...
        do {
            ...
            const events::Object2dArray Object2dArray(preSkeletonAdapter->GetSkeleton(), events::Object2dArrayIntfObject2dArrayId);
            initResult = preSkeletonAdapter->InitializeEvent(Object2dArray);
