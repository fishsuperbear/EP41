...
namespace events
{
    using PlanningResult = ara::com::internal::skeleton::event::EventAdapter<::adsfi::PlanningResult>;
...
private:
    ...
    void ConstructSkeleton(const ara::com::MethodCallProcessingMode mode)
    {
        ...
        const ara::core::Result<void> resultPlanningResult = skeletonAdapter->InitializeEvent(PlanningResult);
...
public:
    ...
    explicit PlanningResultIntfSkeleton(const ara::com::InstanceIdentifier& instanceId,
        ...
        : skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::adsfi::PlanningResultIntf::ServiceIdentifier, instanceId, mode)),
          PlanningResult(skeletonAdapter->GetSkeleton(), events::PlanningResultIntfPlanningResultId){
        ...
        const ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    {
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter> preSkeletonAdapter =
            std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(
                ::adsfi::PlanningResultIntf::ServiceIdentifier, instanceId, mode);
        ...
        const ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    {
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter> preSkeletonAdapter =
            std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(
                ::adsfi::PlanningResultIntf::ServiceIdentifier, instanceSpec, mode);
        return PreConstructResult(preSkeletonAdapter, mode);
    }
        ...
        const ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    {
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter> preSkeletonAdapter =
            std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(
                ::adsfi::PlanningResultIntf::ServiceIdentifier, instanceIdContainer, mode);
        return PreConstructResult(preSkeletonAdapter, mode);
    }
        ...
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter>& preSkeletonAdapter, const ara::com::MethodCallProcessingMode mode)
    {
        ...
        do {
            ...
            const events::PlanningResult PlanningResult(preSkeletonAdapter->GetSkeleton(), events::PlanningResultIntfPlanningResultId);
            initResult = preSkeletonAdapter->InitializeEvent(PlanningResult);
