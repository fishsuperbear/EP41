...
private:
    ...
    void ConstructSkeleton(const ara::com::MethodCallProcessingMode mode)
    {
        ...
        const ara::core::Result<void> resultSammFeatureEvent = skeletonAdapter->InitializeEvent(SammFeatureEvent);
...
public:
    ...
    explicit SammFeatureServiceInterfaceSkeleton(const ara::com::InstanceIdentifier& instanceId,
        ...
        : skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::ara::samm::SammFeatureServiceInterface::ServiceIdentifier, instanceId, mode)),
          SammFeatureEvent(skeletonAdapter->GetSkeleton(), events::SammFeatureServiceInterfaceSammFeatureEventId){
        ...
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter>& preSkeletonAdapter, const ara::com::MethodCallProcessingMode mode)
    {
        ...
        do {
            ...
            const events::SammFeatureEvent SammFeatureEvent(preSkeletonAdapter->GetSkeleton(), events::SammFeatureServiceInterfaceSammFeatureEventId);
