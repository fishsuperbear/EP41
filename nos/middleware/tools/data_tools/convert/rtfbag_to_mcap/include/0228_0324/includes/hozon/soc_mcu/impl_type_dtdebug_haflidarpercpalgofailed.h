...
#ifndef HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_HAFLIDARPERCPALGOFAILED_H
#define HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_HAFLIDARPERCPALGOFAILED_H
#include <cfloat>
#include <cmath>
...
struct DtDebug_HafLidarPercpAlgoFailed {
    ...
    bool operator==(const ::hozon::soc_mcu::DtDebug_HafLidarPercpAlgoFailed& t) const
    {
...
#endif // HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_HAFLIDARPERCPALGOFAILED_H
