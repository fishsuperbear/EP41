...
#ifndef HOZON_SOC2MCU_IMPL_TYPE_HAFLIDARPERCPALGOINTRFAILED_H
#define HOZON_SOC2MCU_IMPL_TYPE_HAFLIDARPERCPALGOINTRFAILED_H
#include <cfloat>
#include <cmath>
...
namespace hozon {
namespace soc2mcu {
struct HafLidarPercpAlgoIntrFailed {
    ...
    bool operator==(const ::hozon::soc2mcu::HafLidarPercpAlgoIntrFailed& t) const
    {
...
#endif // HOZON_SOC2MCU_IMPL_TYPE_HAFLIDARPERCPALGOINTRFAILED_H
