...
namespace events
{
    using FusionObjectArray = ara::com::internal::skeleton::event::EventAdapter<::adsfi::FusionObjectArray>;
...
private:
    ...
    void ConstructSkeleton(const ara::com::MethodCallProcessingMode mode)
    {
        ...
        const ara::core::Result<void> resultFusionObjectArray = skeletonAdapter->InitializeEvent(FusionObjectArray);
...
public:
    ...
    explicit FusionObjectArrayIntfSkeleton(const ara::com::InstanceIdentifier& instanceId,
        ...
        : skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::adsfi::FusionObjectArrayIntf::ServiceIdentifier, instanceId, mode)),
          FusionObjectArray(skeletonAdapter->GetSkeleton(), events::FusionObjectArrayIntfFusionObjectArrayId){
        ...
        const ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    {
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter> preSkeletonAdapter =
            std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(
                ::adsfi::FusionObjectArrayIntf::ServiceIdentifier, instanceId, mode);
        ...
        const ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    {
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter> preSkeletonAdapter =
            std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(
                ::adsfi::FusionObjectArrayIntf::ServiceIdentifier, instanceSpec, mode);
        return PreConstructResult(preSkeletonAdapter, mode);
    }
        ...
        const ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    {
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter> preSkeletonAdapter =
            std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(
                ::adsfi::FusionObjectArrayIntf::ServiceIdentifier, instanceIdContainer, mode);
        return PreConstructResult(preSkeletonAdapter, mode);
    }
        ...
        std::unique_ptr<ara::com::internal::skeleton::SkeletonAdapter>& preSkeletonAdapter, const ara::com::MethodCallProcessingMode mode)
    {
        ...
        do {
            ...
            const events::FusionObjectArray FusionObjectArray(preSkeletonAdapter->GetSkeleton(), events::FusionObjectArrayIntfFusionObjectArrayId);
            initResult = preSkeletonAdapter->InitializeEvent(FusionObjectArray);
