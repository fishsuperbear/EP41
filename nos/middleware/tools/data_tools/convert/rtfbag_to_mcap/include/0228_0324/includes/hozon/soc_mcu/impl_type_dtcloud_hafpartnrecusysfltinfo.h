...
#ifndef HOZON_SOC_MCU_IMPL_TYPE_DTCLOUD_HAFPARTNRECUSYSFLTINFO_H
#define HOZON_SOC_MCU_IMPL_TYPE_DTCLOUD_HAFPARTNRECUSYSFLTINFO_H
#include <cfloat>
#include <cmath>
...
struct DtCloud_HafpartnrEcuSysFltInfo {
    ...
    bool operator==(const ::hozon::soc_mcu::DtCloud_HafpartnrEcuSysFltInfo& t) const
    {
...
#endif // HOZON_SOC_MCU_IMPL_TYPE_DTCLOUD_HAFPARTNRECUSYSFLTINFO_H
