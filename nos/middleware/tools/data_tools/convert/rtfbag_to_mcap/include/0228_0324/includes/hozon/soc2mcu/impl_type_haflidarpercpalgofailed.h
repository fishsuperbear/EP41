...
#ifndef HOZON_SOC2MCU_IMPL_TYPE_HAFLIDARPERCPALGOFAILED_H
#define HOZON_SOC2MCU_IMPL_TYPE_HAFLIDARPERCPALGOFAILED_H
#include <cfloat>
#include <cmath>
...
namespace hozon {
namespace soc2mcu {
struct HafLidarPercpAlgoFailed {
    ...
    bool operator==(const ::hozon::soc2mcu::HafLidarPercpAlgoFailed& t) const
    {
...
#endif // HOZON_SOC2MCU_IMPL_TYPE_HAFLIDARPERCPALGOFAILED_H
