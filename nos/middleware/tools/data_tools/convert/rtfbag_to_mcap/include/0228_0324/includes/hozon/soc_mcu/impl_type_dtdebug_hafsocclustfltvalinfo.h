...
#ifndef HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_HAFSOCCLUSTFLTVALINFO_H
#define HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_HAFSOCCLUSTFLTVALINFO_H
#include <cfloat>
#include <cmath>
...
struct DtDebug_HafsocClustFltValInfo {
    ...
    bool operator==(const ::hozon::soc_mcu::DtDebug_HafsocClustFltValInfo& t) const
    {
...
#endif // HOZON_SOC_MCU_IMPL_TYPE_DTDEBUG_HAFSOCCLUSTFLTVALINFO_H
