...
#ifndef HOZON_SOC_MCU_IMPL_TYPE_DTCLOUD_HAFMSGSOCTOMCUALIVEFLTINFO_H
#define HOZON_SOC_MCU_IMPL_TYPE_DTCLOUD_HAFMSGSOCTOMCUALIVEFLTINFO_H
#include <cfloat>
#include <cmath>
...
struct DtCloud_HafmsgSocToMcuAliveFltInfo {
    ...
    bool operator==(const ::hozon::soc_mcu::DtCloud_HafmsgSocToMcuAliveFltInfo& t) const
    {
...
#endif // HOZON_SOC_MCU_IMPL_TYPE_DTCLOUD_HAFMSGSOCTOMCUALIVEFLTINFO_H
