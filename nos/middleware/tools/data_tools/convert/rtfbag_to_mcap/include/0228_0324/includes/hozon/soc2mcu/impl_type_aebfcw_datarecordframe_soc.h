...
#ifndef HOZON_SOC2MCU_IMPL_TYPE_AEBFCW_DATARECORDFRAME_SOC_H
#define HOZON_SOC2MCU_IMPL_TYPE_AEBFCW_DATARECORDFRAME_SOC_H
#include <cfloat>
#include <cmath>
...
namespace hozon {
namespace soc2mcu {
struct AEBFCW_DataRecordFrame_soc {
    ...
    bool operator==(const ::hozon::soc2mcu::AEBFCW_DataRecordFrame_soc& t) const
    {
        return (Pi_AEBCan3BusRx == t.Pi_AEBCan3BusRx) && (HafSwc2AEBTypeData == t.HafSwc2AEBTypeData) && (HafAebFcwFaultBus == t.HafAebFcwFaultBus) && (Pi_AEBCan3BusTx == t.Pi_AEBCan3BusTx) && (HafAEB2SwcTypeData == t.HafAEB2SwcTypeData) && (HafAEB2NVMTypeData == t.HafAEB2NVMTypeData) && (HafAEBSDebugBusTypeData == t.HafAEBSDebugBusTypeData) && (header == t.header);
    }
};
} // namespace soc2mcu
} // namespace hozon
...
#endif // HOZON_SOC2MCU_IMPL_TYPE_AEBFCW_DATARECORDFRAME_SOC_H
