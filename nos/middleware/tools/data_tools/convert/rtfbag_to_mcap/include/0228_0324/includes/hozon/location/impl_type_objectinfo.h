...
#ifndef HOZON_LOCATION_IMPL_TYPE_OBJECTINFO_H
#define HOZON_LOCATION_IMPL_TYPE_OBJECTINFO_H
#include <cfloat>
#include <cmath>
...
struct objectInfo {
    ...
    bool operator==(const ::hozon::location::objectInfo& t) const
    {
...
#endif // HOZON_LOCATION_IMPL_TYPE_OBJECTINFO_H
