...
class ROSBAG2_CPP_PUBLIC SequentialReader : public ::rosbag2_cpp::reader_interfaces::BaseReaderInterface {
   public:
    SequentialReader(std::unique_ptr<rosbag2_storage::StorageFactoryInterface> storage_factory = std::make_unique<rosbag2_storage::StorageFactory>(),
    ...
    bool open(const rosbag2_storage::StorageOptions& storage_options, const ConverterOptions& converter_options) override;
