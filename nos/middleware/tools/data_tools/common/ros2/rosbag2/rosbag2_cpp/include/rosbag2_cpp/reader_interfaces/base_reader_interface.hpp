...
public:
  ...
  virtual std::shared_ptr<rosbag2_storage::Attachment> read_Attachment(std::string name) = 0;

  virtual void get_all_attachments_filepath(std::vector<std::string> &attach_list) = 0;
};
