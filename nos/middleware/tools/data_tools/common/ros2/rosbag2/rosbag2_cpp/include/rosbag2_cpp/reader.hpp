...
class ROSBAG2_CPP_PUBLIC Reader final {
   ...
   */
    bool open(const rosbag2_storage::StorageOptions& storage_options, const ConverterOptions& converter_options = ConverterOptions());
   ...
   */
    ...
    MessageT read_next() {
        ...
        msg.deserialize_message(*bag_message->serialized_data);
        return msg;
    }
