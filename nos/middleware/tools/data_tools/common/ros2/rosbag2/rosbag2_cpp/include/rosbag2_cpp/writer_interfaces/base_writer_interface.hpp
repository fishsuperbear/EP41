...
#include "rosbag2_storage/attachment.hpp"
...
class ROSBAG2_CPP_PUBLIC BaseWriterInterface {
   public:
    ...
    virtual void add_attach(std::shared_ptr<rosbag2_storage::Attachment> attachment) = 0;

    virtual void add_attach_to_list(std::shared_ptr<rosbag2_storage::Attachment> &attachment) = 0;
    /**
