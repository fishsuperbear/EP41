  ...
  const DefinitionIdentifier & definition_identifier)
{
  ...
  std::string package = "data_type";
  std::string share_dir = ament_index_cpp::get_search_paths().front() + "/share/" + package;

  std::ifstream file{share_dir + "/" + definition_identifier.package_resource_name +
