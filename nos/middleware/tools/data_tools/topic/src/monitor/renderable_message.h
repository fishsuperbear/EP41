...
class RenderableMessage {
   public:
    ...
    explicit RenderableMessage(RenderableMessage* parent = nullptr, int line_no = 0) : line_no_(line_no), pages_(1), page_index_(0), page_item_count_(24), parent_(parent), frame_ratio_(0.0) {}
