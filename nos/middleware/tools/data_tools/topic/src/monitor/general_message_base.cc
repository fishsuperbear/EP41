...
int GeneralMessageBase::LineCountOfField(const google::protobuf::Message& msg, int screen_width, const google::protobuf::FieldDescriptor* field, const google::protobuf::Reflection* reflection,
                                         bool is_folded) {
    int ret = 0;
...
void GeneralMessageBase::PrintMessage(GeneralMessageBase* baseMsg, const google::protobuf::Message& msg, int* jump_lines, const Screen* s, int* line_no, int indent) {
    const google::protobuf::Reflection* reflection = msg.GetReflection();
    const google::protobuf::Descriptor* descriptor = msg.GetDescriptor();
    std::vector<const google::protobuf::FieldDescriptor*> fields;
    if (descriptor->options().map_entry()) {
...
void GeneralMessageBase::PrintField(GeneralMessageBase* baseMsg, const google::protobuf::Message& msg, int* jump_lines, const Screen* s, int* line_no, int indent,
                                    const google::protobuf::Reflection* ref, const google::protobuf::FieldDescriptor* field, int index) {
    std::ostringstream out_str;
...
#define OUTPUT_FIELD(CPPTYPE, METHOD, PRECISION)                                                                                                                          \
    case google::protobuf::FieldDescriptor::CPPTYPE_##CPPTYPE:                                                                                                            \
        if (*jump_lines) {                                                                                                                                                \
            ...
            out_str << std::fixed << std::setprecision(PRECISION) << (field->is_repeated() ? ref->GetRepeated##METHOD(msg, field, index) : ref->Get##METHOD(msg, field)); \
...
#undef OUTPUT_FIELD
        ...
        case google::protobuf::FieldDescriptor::CPPTYPE_STRING: {
            std::string scratch;
            const std::string& str = field->is_repeated() ? ref->GetRepeatedStringReference(msg, field, index, &scratch) : ref->GetStringReference(msg, field, &scratch);
            {
                int line_width = 0;
                std::size_t i = 0;
        ...
        case google::protobuf::FieldDescriptor::CPPTYPE_ENUM: {
            if (*jump_lines) {
                ...
                int enum_value = field->is_repeated() ? ref->GetRepeatedEnumValue(msg, field, index) : ref->GetEnumValue(msg, field);
        ...
        case google::protobuf::FieldDescriptor::CPPTYPE_MESSAGE:
            ...
            GeneralMessageBase::PrintMessage(baseMsg, field->is_repeated() ? ref->GetRepeatedMessage(msg, field, index) : ref->GetMessage(msg, field), jump_lines, s, line_no, indent + 2);
            break;
    }
}
...
void GeneralMessageBase::PrintSomeipMessage(GeneralMessageBase* baseMsg, const std::vector<std::string>& msgs, int& jump_lines, const Screen* s, int* line_no, int indent) {

    for (size_t i = jump_lines; (i < msgs.size() && i < i + baseMsg->page_item_count()); i++)
    {
        std::string out_str = msgs[i];
        s->AddStr(indent, (*line_no)++, out_str.c_str());
    }
