 ...
 * Module: per
 * Description: KV json文件存储
 * Created on: Feb 7, 2023
 *
 */
#ifndef MIDDLEWARE_JSON_PER_SRC_KEY_VALUE_STORAGE_IMPL_H_
#define MIDDLEWARE_JSON_PER_SRC_KEY_VALUE_STORAGE_IMPL_H_
...
class JsonKeyValueStorageImpl : public KeyValueStorage {
 public:
    explicit JsonKeyValueStorageImpl(const StorageConfig& config);
    ~JsonKeyValueStorageImpl();
    JsonKeyValueStorageImpl(const JsonKeyValueStorageImpl& obj) = delete;
    JsonKeyValueStorageImpl& operator=(const JsonKeyValueStorageImpl& obj) = delete;
...
#endif  // MIDDLEWARE_JSON_PER_SRC_KEY_VALUE_STORAGE_IMPL_H_
