...
namespace fsm
{
    ...
    public:
        ...
        void set( const fsm::state &state ) {
             if( deque.size() ) {
                // std::cout << "gtx-> step size = " << deque.size() <<std::endl;
    ...
    protected:
        ...
        void replace( fsm::state &current, const fsm::state &next ) {
            //std::cout << "gtx-> cur stat  = " << current <<std::endl;
            //std::cout << "gtx-> next stat  = " << next <<std::endl;
            call( current, 'quit' );
            //std::cout << "gtx-> quit end   = " << current <<std::endl;
            current = next;
            //std::cout << "gtx-> next stat  = " << current <<std::endl;
            call( current, 'init' );
            //std::cout << "gtx-> init end  = " << current <<std::endl;
        }
