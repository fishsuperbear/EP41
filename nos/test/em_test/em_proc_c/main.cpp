...
{
    std::cout << "proc c signal:<<"<< sig << std::endl;
    g_stopFlag = 1;
}
...
int main(int argc, char* argv[])
{
    ...
    if(ret){ std::cout << "c report fail." << std::endl; }
