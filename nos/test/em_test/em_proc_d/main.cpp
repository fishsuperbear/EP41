...
{
    std::cout << "pro d sig:<<"<< sig << std::endl;
    g_stopFlag = 1;
}
...
int main(int argc, char* argv[])
{
    ...
    if(ret){ std::cout << "d report fail." << std::endl; }
