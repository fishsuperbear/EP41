...
{
    std::cout << "pro f sig:<<"<< sig << std::endl; 
    g_stopFlag = 1;
}
...
int main(int argc, char* argv[])
{
    ...
    if(ret){ std::cout << "f report fail." << std::endl; }
