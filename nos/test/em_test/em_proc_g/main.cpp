...
{
    std::cout << "pro g sig:<<"<< sig << std::endl; 
    g_stopFlag = 1;
}
...
int main(int argc, char* argv[])
{
    ...
    if(ret){ std::cout << "g report fail." << std::endl; }
