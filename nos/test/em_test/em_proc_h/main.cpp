...
{
    std::cout << "pro h sig:<<"<< sig << std::endl; 
    g_stopFlag = 1;
}
...
int main(int argc, char* argv[])
{
    ...
    if(ret){ std::cout << "h report fail." << std::endl; }
