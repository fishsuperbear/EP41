...
{
    std::cout << "pro n sig:<<"<< sig << std::endl; 
    g_stopFlag = 1;
}
...
int main(int argc, char* argv[])
{
    ...
    if(ret){ std::cout << "n report fail." << std::endl; }
