...
{
    std::cout << "pro l sig:<<"<< sig << std::endl; 
    g_stopFlag = 1;
}
...
int main(int argc, char* argv[])
{
    ...
    if(ret){ std::cout << "l report fail." << std::endl; }
