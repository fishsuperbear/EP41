...
{
    std::cout << "pro e sig:<<"<< sig << std::endl;
    g_stopFlag = 1;
}
...
int main(int argc, char* argv[])
{
    ...
    if(ret){ std::cout << "e report fail." << std::endl; }
