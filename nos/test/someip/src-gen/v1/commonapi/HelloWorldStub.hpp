...
class HelloWorldStubAdapter
 ...
 public:
    /**
    * Sends a broadcast event for McuCANMsgService. Should not be called directly.
    * Instead, the "fire<broadcastName>Event" methods of the stub should be used.
    */
    virtual void fireMcuCANMsgServiceEvent(const ::v1::commonapi::HelloWorld::McuCANMsgAlgo &_test) = 0;
...
public:
    ...
    /// Sends a broadcast event for McuCANMsgService.
    virtual void fireMcuCANMsgServiceEvent(const ::v1::commonapi::HelloWorld::McuCANMsgAlgo &_test) {
        auto stubAdapter = CommonAPI::Stub<HelloWorldStubAdapter, HelloWorldStubRemoteEvent>::stubAdapter_.lock();
        if (stubAdapter)
            stubAdapter->fireMcuCANMsgServiceEvent(_test);
    }
