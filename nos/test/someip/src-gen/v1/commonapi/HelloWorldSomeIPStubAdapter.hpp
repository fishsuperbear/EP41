...
public:
    ...
    void fireMcuCANMsgServiceEvent(const ::v1::commonapi::HelloWorld::McuCANMsgAlgo &_test);
        ...
        getHelloWorldInterfaceVersionStubDispatcher(&HelloWorldStub::lockInterfaceVersionAttribute, &HelloWorldStub::getInterfaceVersion, false, true)
    {
        // Provided events/fields
        {
            ...
            itsEventGroups.insert(CommonAPI::SomeIP::eventgroup_id_t(0x107));
            CommonAPI::SomeIP::StubAdapter::registerEvent(CommonAPI::SomeIP::event_id_t(0x8022), itsEventGroups, CommonAPI::SomeIP::event_type_e::ET_EVENT, CommonAPI::SomeIP::reliability_type_e::RT_UNRELIABLE);
        }
    }
...
void HelloWorldSomeIPStubAdapterInternal<_Stub, _Stubs...>::fireMcuCANMsgServiceEvent(const ::v1::commonapi::HelloWorld::McuCANMsgAlgo &_test) {
    CommonAPI::Deployable< HelloWorld::McuCANMsgAlgo, ::v1::commonapi::HelloWorld_::McuCANMsgAlgoDeployment_t> deployed_test(_test, &::v1::commonapi::HelloWorld_::McuCANMsgAlgoDeployment);
    CommonAPI::SomeIP::StubEventHelper<CommonAPI::SomeIP::SerializableArguments<  CommonAPI::Deployable< ::v1::commonapi::HelloWorld::McuCANMsgAlgo, ::v1::commonapi::HelloWorld_::McuCANMsgAlgoDeployment_t > 
    >>
        ::sendEvent(
            *this,
            CommonAPI::SomeIP::event_id_t(0x8022),
            false,
             deployed_test 
    );
}
