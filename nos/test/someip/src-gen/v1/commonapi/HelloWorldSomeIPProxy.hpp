...
public:
    ...
    virtual McuCANMsgServiceEvent& getMcuCANMsgServiceEvent();
...
private:
    CommonAPI::SomeIP::Event<McuCANMsgServiceEvent, CommonAPI::Deployable< ::v1::commonapi::HelloWorld::McuCANMsgAlgo, ::v1::commonapi::HelloWorld_::McuCANMsgAlgoDeployment_t >> mcuCANMsgService_;
