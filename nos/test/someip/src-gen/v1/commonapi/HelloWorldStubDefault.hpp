...
public:
    ...
    COMMONAPI_EXPORT virtual void fireMcuCANMsgServiceEvent(const ::v1::commonapi::HelloWorld::McuCANMsgAlgo &_test) {
        HelloWorldStub::fireMcuCANMsgServiceEvent(_test);
    }
