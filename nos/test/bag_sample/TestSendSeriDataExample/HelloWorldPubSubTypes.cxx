...
HelloWorldPubSubType::HelloWorldPubSubType() {
    std::cout << "new HelloWorldPubSubType" << std::endl;
    ...
    std::cout << "new HelloWorldPubSubTypes ok." << std::endl;
}
...
//采用C模式读二进制文件
// void HelloWorldPubSubType::DataRead_CMode(SerializedPayload_t* payload)
// {
...
bool HelloWorldPubSubType::deserialize(SerializedPayload_t* payload, void* data) {
    std::cout << "HelloWorldPubSubType::deserialize start" << std::endl;
...
std::function<uint32_t()> HelloWorldPubSubType::getSerializedSizeProvider(void* data) {
    return [data]() -> uint32_t {
        return static_cast<uint32_t>(type::getCdrSerializedSize(*static_cast<TestWorld*>(data))) + 4u /*encapsulation*/;
    };
    return 0;
}
...
bool HelloWorldPubSubType::getKey(void* data, InstanceHandle_t* handle, bool force_md5) {
    // std::cout << "HelloWorldPubSubType::getKey start" << std::endl;
