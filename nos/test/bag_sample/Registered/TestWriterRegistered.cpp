...
TestWriterRegistered::TestWriterRegistered() : mp_participant(nullptr), mp_writer(nullptr), mp_history(nullptr) {}
...
bool TestWriterRegistered::init() {
    ...
    PParam.builtin.typelookup_config.use_server = true;  //typelooup
