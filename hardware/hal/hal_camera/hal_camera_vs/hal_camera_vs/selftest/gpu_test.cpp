...
{
    printf("do handle_cuda_buffer++++++++++buffer+ blocktype[%c],sensor[%d]capturetsc[%llu] bufsize = %d\r\n", 
		'A' + i_pbufferinfo->blocktype - 1, i_pbufferinfo->sensorindex, i_pbufferinfo->timeinfo.framecapturetsc, 
		i_pbufferinfo->pgpuinfo->prgbinfo->buffsize);
}
