...
/**
 * @brief Get the hardware platform time stamp in nanoseconds
 *
 * This function is used to retrieve the current system's time stamp, which is a 64-bit unsigned integer representing the number of nanoseconds elapsed since an unspecified epoch.
 *
 * @param io_tsc_ns A pointer to a 64-bit unsigned integer that will hold the time stamp on output.
 *                  The value pointed to by this parameter will be updated with the retrieved time stamp.
 */
