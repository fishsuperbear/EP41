...
{
    /** Holds the TSC timestamp of the end of frame for capture, the units are ns. */
    u64 framecapturetsc;
    /** Holds the TSC timestamp of the start of frame for capture, the units are ns. */
    u64 framecapturestarttsc;
    /** Holds exposure time for each active exposure, the units are ns. */
    u64 exposurestarttime;
