...
HWNvmediaMultiIpcConsumerEncContext::HWNvmediaMultiIpcConsumerEncContext(struct hw_video_t* i_pvideo)
	...
	*/
	...
	_deviceopenpara.Init(HW_NVMEDIA_APPTYPE_IPC_CONSUMER_ENC,
		...
		/* "XPC_MULTIPLE_CAMERA", */
		/* "0x1011 0x0000 0x0000", 1, "/usr/share/camera/"); */
        /* 140 shanghai orin board use
		"HZ_multi_camera",
        "0x0000 0x0001 0x0000", 1, "/usr/share/camera/");*/
		"XPC_MULTIPLE_CAMERA",
		"0x1011 0x1111 0x1111", 1, "/usr/share/camera/");
#endif
		/* "HZ_multi_camera", */
...
hw_ret_s32 HWNvmediaMultiIpcConsumerEncContext::GetRegDataCbType_OutputType(HW_VIDEO_REGDATACB_TYPE i_regdatacbtype,
