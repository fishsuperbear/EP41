#ifndef HW_NVMEDIA_MULTI_GROUP_IMPL_H
#define HW_NVMEDIA_MULTI_GROUP_IMPL_H
...
*/
class HWNvmediaMultiGroupContext : public HWNvmediaSingleProcessContext
{
private:
	HWNvmediaMultiGroupContext();
public:
	HWNvmediaMultiGroupContext(struct hw_video_t* i_pvideo);
	~HWNvmediaMultiGroupContext()
	{
...
class HWNvmediaMultiGroupEnv
{
public:
	HWNvmediaMultiGroupEnv()
	{
		/*
...
public:
	...
	*/
	HWNvmediaMultiGroupContext*			pcontext = NULL;
	/*
