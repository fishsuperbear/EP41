#ifndef HW_NVMEDIA_DEF_GROUPA_IMPL_H
#define HW_NVMEDIA_DEF_GROUPA_IMPL_H
...
/*
* When it is 1, it will create a CCudaConsumer instance to use the camera data.
*/
#define HW_NVMEDIA_USE_CUDA_CONSUMER						1
/*
* Use encoder consumer as the encoder do not support yuv422 format(isx021 rawoutput format).
* The encoder only support yuv sub format: yuv444 and yuv420sp.
*/
#define HW_NVMEDIA_USE_ENCODER_CONSUMER						1
/*
* When it is 1, it will create a CCommonConsumer instance to use the camera data.
*/
#define HW_NVMEDIA_USE_COMMON_CONSUMER						0
/*
* When it is 1, it will create a CVICConsumer instance to use the camera data.
*/
#define HW_NVMEDIA_USE_VIC_CONSUMER							0

enum INTERNAL_CHECK_HW_NVMEDIA_USE_CONSUMER {
#if (HW_NVMEDIA_USE_CUDA_CONSUMER == 1)
	USE_CUDA_CONSUMER,
#endif
#if (HW_NVMEDIA_USE_ENCODER_CONSUMER == 1)
	USE_ENCODER_CONSUMER,
#endif
#if (HW_NVMEDIA_USE_COMMON_CONSUMER == 1)
	USE_COMMON_CONSUMER,
#endif
#if (HW_NVMEDIA_USE_VIC_CONSUMER ==1)
	USE_VIC_CONSUMER,
#endif
	/*
	* First consumer: Cuda
...
enum HW_NVMEDIA_APPTYPE
{
	...
	HW_NVMEDIA_APPTYPE_IPC_SIPL_PRODUCER,
