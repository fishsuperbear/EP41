...
public:
    ...
    virtual SIPLStatus CreateBlocks(HWNvmediaSensorOutputPipelineProfiler *pProfiler,int encodeType) = 0;
    virtual SIPLStatus CreateBlocksWithVIC(HWNvmediaSensorOutputPipelineProfiler* pProfiler, int encodeType, void* i_pvicconsumer) {
        // default can not run here, you need to define the virtual in the sub class
...
public:
    ...
    void SetUsecaseInfo(UseCaseInfo &info)
    {
        m_usecaseInfo = info;
    }
