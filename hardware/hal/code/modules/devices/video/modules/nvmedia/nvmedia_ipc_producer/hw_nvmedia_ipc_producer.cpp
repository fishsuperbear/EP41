...
#if (HW_NVMEDIA_PROJ == HW_NVMEDIA_PROJ_IPC_PRODUCER)
#include "hw_nvmedia_common_impl.h"
#include "hw_nvmedia_ipc_producer_impl.h"

extern "C" struct hw_nvmedia_ipc_producer_module_t HAL_MODULE_INFO_SYM;
struct hw_nvmedia_ipc_producer_module_t HAL_MODULE_INFO_SYM =
{
	.common = {
...
static HWNvmediaIpcProducerEnv		_env;
...
s32 hw_module_privapi_device_get(struct hw_module_t* i_pmodule, void* i_param, struct hw_device_t** io_ppdevice)
{
	...
	*/
	...
	{
		_env.pcontext = new HWNvmediaIpcProducerAContext(pvideo);
...
s32 hw_module_privapi_device_put(struct hw_module_t* i_pmodule, struct hw_device_t* i_pdevice)
{
	...
	HWNvmediaIpcProducerAContext* pcontext = (HWNvmediaIpcProducerAContext*)pvideo->priv;
	delete(pcontext);
	delete(pvideo);
	return 0;
}
