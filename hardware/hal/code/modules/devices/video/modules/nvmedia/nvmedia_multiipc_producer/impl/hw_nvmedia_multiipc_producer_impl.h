#ifndef HW_NVMEDIA_MULTIIPC_PRODUCER_IMPL_H
#define HW_NVMEDIA_MULTIIPC_PRODUCER_IMPL_H

#include "hw_nvmedia_common_impl.h"
#include "hw_nvmedia_multiipc_producer.h"

/*
* The instance of the class is stored in priv of hw_video_t.
*/
class HWNvmediaMultiIpcProducerAContext : public HWNvmediaIpcProducerContext
{
private:
	HWNvmediaMultiIpcProducerAContext();
public:
	HWNvmediaMultiIpcProducerAContext(struct hw_video_t* i_pvideo);
	~HWNvmediaMultiIpcProducerAContext()
	{
...
class HWNvmediaMultiIpcProducerEnv
{
public:
	HWNvmediaMultiIpcProducerEnv()
	{
		/*
...
public:
	...
	*/
	HWNvmediaMultiIpcProducerAContext*	pcontext = NULL;
	/*
	* The referene count of pcontext.
	*/
	u32								refcount_pcontext;
    hw_event_t                      _main_pevent;
};
...
#endif // HW_NVMEDIA_MULTIIPC_PRODUCER_IMPL_H
