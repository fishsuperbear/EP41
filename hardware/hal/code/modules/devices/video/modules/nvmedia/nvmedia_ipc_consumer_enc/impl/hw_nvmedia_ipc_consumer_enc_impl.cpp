#include "hw_nvmedia_ipc_consumer_enc_impl.h"

#include "hw_nvmedia_eventhandler_impl.h"

#define INTERNAL_IPC_CONSUMER_ENC_BLOCKDEVICE_ONLY_IMX728 0
#define INTERNAL_IPC_CONSUMER_ENC_BLOCKDEVICE_ONLY_ISX021 1
#define INTERNAL_IPC_CONSUMER_ENC_BLOCKDEVICE_ONLY_X8B 2

#define INTERNAL_IPC_CONSUMER_ENC_BLOCKDEVICE INTERNAL_IPC_CONSUMER_ENC_BLOCKDEVICE_ONLY_IMX728

#define INTERNAL_VERSION_6050 0
#define INTERNAL_VERSION_6060 1
#define INTERNAL_VERSION INTERNAL_VERSION_6060

#define INTERNAL_BOARD_SHANGHAI 0
#define INTERNAL_BOARD_BEIJING 1

#define INTERNAL_BOARD INTERNAL_BOARD_SHANGHAI

HWNvmediaIpcConsumerEncContext::HWNvmediaIpcConsumerEncContext(struct hw_video_t* i_pvideo)
    : HWNvmediaIpcConsumerContext(i_pvideo) {
#if (INTERNAL_IPC_CONSUMER_ENC_BLOCKDEVICE == INTERNAL_IPC_CONSUMER_ENC_BLOCKDEVICE_ONLY_IMX728)
#if (INTERNAL_VERSION == INTERNAL_VERSION_6060)
    /*
     * 1 mean use mailbox mode.
     */
    _deviceopenpara.Init(HW_NVMEDIA_APPTYPE_IPC_CONSUMER_ENC,
...
#endif
#endif
#if (INTERNAL_IPC_CONSUMER_ENC_BLOCKDEVICE == INTERNAL_IPC_CONSUMER_ENC_BLOCKDEVICE_ONLY_ISX021)
#if (INTERNAL_BOARD == INTERNAL_BOARD_SHANGHAI)
    /*
     * 1 mean use mailbox mode.
     */
    _deviceopenpara.Init(HW_NVMEDIA_APPTYPE_IPC_CONSUMER_CUDA,
                         "ISX021_DPHY_x4",
                         "0x0010 0 0 0", 1, "/opt/nvidia/nvmedia/nit/");  // "0x0010 0 0 0" in 6050 shanghai banzi
#else
    /*
     * 1 mean use mailbox mode.
     */
    _deviceopenpara.Init(HW_NVMEDIA_APPTYPE_IPC_CONSUMER_CUDA,
                         "ISX021_DPHY_x4",
                         "0x0100 0 0 0", 1, "/opt/nvidia/nvmedia/nit/");  // "0x0100 0 0 0" in 6050 beijing banzi
#endif
#endif
#if (INTERNAL_IPC_CONSUMER_ENC_BLOCKDEVICE == INTERNAL_IPC_CONSUMER_ENC_BLOCKDEVICE_ONLY_X8B)
    /*
     * 1 mean use mailbox mode.
     */
    _deviceopenpara.Init(HW_NVMEDIA_APPTYPE_IPC_CONSUMER_CUDA,
                         "X8B_DPHY_x4",
                         "0x0001 0 0 0", 1, "/opt/nvidia/nvmedia/nit/");
#endif
}

hw_ret_s32 HWNvmediaIpcConsumerEncContext::GetRegDataCbType_OutputType(HW_VIDEO_REGDATACB_TYPE i_regdatacbtype,
                                                                       HW_VIDEO_INPUT_TYPE inputType, HWNvmediaEventHandlerRegDataCbConfig* o_pcbconfig) {
#if ((INTERNAL_IPC_CONSUMER_ENC_BLOCKDEVICE == INTERNAL_IPC_CONSUMER_ENC_BLOCKDEVICE_ONLY_IMX728) || (INTERNAL_IPC_CONSUMER_ENC_BLOCKDEVICE == INTERNAL_IPC_CONSUMER_ENC_BLOCKDEVICE_ONLY_X8B))
