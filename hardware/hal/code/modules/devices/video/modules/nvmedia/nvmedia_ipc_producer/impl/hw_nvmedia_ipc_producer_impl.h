#ifndef HW_NVMEDIA_IPC_PRODUCER_IMPL_H
#define HW_NVMEDIA_IPC_PRODUCER_IMPL_H

#include "hw_nvmedia_common_impl.h"
#include "hw_nvmedia_ipc_producer.h"

/*
* The instance of the class is stored in priv of hw_video_t.
*/
class HWNvmediaIpcProducerAContext : public HWNvmediaIpcProducerContext
{
private:
	HWNvmediaIpcProducerAContext();
public:
	HWNvmediaIpcProducerAContext(struct hw_video_t* i_pvideo);
	~HWNvmediaIpcProducerAContext()
	{
...
class HWNvmediaIpcProducerEnv
{
public:
	HWNvmediaIpcProducerEnv()
	{
		/*
...
public:
	...
	*/
	HWNvmediaIpcProducerAContext*	pcontext = NULL;
	/*
...
#endif // HW_NVMEDIA_IPC_PRODUCER_IMPL_H
