#ifndef HW_NVMEDIA_IPC_CONSUMER_ENC_IMPL_H
#define HW_NVMEDIA_IPC_CONSUMER_ENC_IMPL_H

#include "hw_nvmedia_common_impl.h"
#include "hw_nvmedia_ipc_consumer_enc.h"

/*
 * Groupa context.
 * The instance of the class is stored in priv of hw_video_t.
 */
class HWNvmediaIpcConsumerEncContext : public HWNvmediaIpcConsumerContext {
private:
    HWNvmediaIpcConsumerEncContext();

public:
    HWNvmediaIpcConsumerEncContext(struct hw_video_t* i_pvideo);
    ~HWNvmediaIpcConsumerEncContext() {
    }
...
class HWNvmediaIpcConsumerEncEnv {
public:
    HWNvmediaIpcConsumerEncEnv() {
        /*
...
public:
     ...
     */
    HWNvmediaIpcConsumerEncContext* pcontext = NULL;
    /*
...
#endif  // HW_NVMEDIA_IPC_CONSUMER_ENC_IMPL_H
