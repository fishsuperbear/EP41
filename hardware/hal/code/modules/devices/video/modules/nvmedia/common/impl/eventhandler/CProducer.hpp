...
public:
    ...
    CProducer(std::string name, NvSciStreamBlock handle, uint32_t uSensor, std::shared_ptr<CAttributeProvider> attrProvider = nullptr);
...
protected:
    ...
    virtual SIPLStatus HandleSyncExport(void) override;
    ...
    std::shared_ptr<CAttributeProvider> m_attrProvider = nullptr;
};
#endif
