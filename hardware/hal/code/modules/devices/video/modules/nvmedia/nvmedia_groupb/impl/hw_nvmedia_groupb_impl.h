#ifndef HW_NVMEDIA_GROUPB_IMPL_H
#define HW_NVMEDIA_GROUPB_IMPL_H
...
*/
class HWNvmediaGroupbContext : public HWNvmediaSingleProcessContext
{
private:
	HWNvmediaGroupbContext();
public:
	HWNvmediaGroupbContext(struct hw_video_t* i_pvideo);
	~HWNvmediaGroupbContext()
	{
...
public:
	...
	*/
	HWNvmediaGroupbContext*			pcontext = NULL;
	/*
