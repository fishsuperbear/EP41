#ifndef HW_NVMEDIA_MULTIIPC_CONSUMER_ENC_IMPL_H
#define HW_NVMEDIA_MULTIIPC_CONSUMER_ENC_IMPL_H

#include "hw_nvmedia_common_impl.h"
#include "hw_nvmedia_multiipc_consumer_enc.h"

/*
 * Groupa context.
 * The instance of the class is stored in priv of hw_video_t.
 */
class HWNvmediaMultiIpcConsumerEncContext : public HWNvmediaIpcConsumerContext {
private:
    HWNvmediaMultiIpcConsumerEncContext();

public:
    HWNvmediaMultiIpcConsumerEncContext(struct hw_video_t* i_pvideo);
    ~HWNvmediaMultiIpcConsumerEncContext() {
    }
...
class HWNvmediaMultiIpcConsumerEncEnv {
public:
    HWNvmediaMultiIpcConsumerEncEnv() {
        /*
...
public:
     ...
     */
    HWNvmediaMultiIpcConsumerEncContext* pcontext = NULL;
    /*
...
#endif  // HW_NVMEDIA_MULTIIPC_CONSUMER_ENC_IMPL_H
