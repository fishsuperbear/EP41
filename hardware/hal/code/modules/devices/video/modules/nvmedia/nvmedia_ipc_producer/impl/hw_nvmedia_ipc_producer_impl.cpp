#include "hw_nvmedia_ipc_producer_impl.h"
#include "hw_nvmedia_eventhandler_impl.h"

#define INTERNAL_IPC_PRODUCER_BLOCKDEVICE_ONLY_IMX728			0
#define INTERNAL_IPC_PRODUCER_BLOCKDEVICE_ONLY_ISX021			1
#define INTERNAL_IPC_PRODUCER_BLOCKDEVICE_ONLY_X8B			    2

#define INTERNAL_IPC_PRODUCER_BLOCKDEVICE						INTERNAL_IPC_PRODUCER_BLOCKDEVICE_ONLY_IMX728
...
HWNvmediaIpcProducerAContext::HWNvmediaIpcProducerAContext(struct hw_video_t* i_pvideo)
	: HWNvmediaIpcProducerContext(i_pvideo)
{
#if (INTERNAL_IPC_PRODUCER_BLOCKDEVICE == INTERNAL_IPC_PRODUCER_BLOCKDEVICE_ONLY_IMX728)
...
#endif
#endif
#if (INTERNAL_IPC_PRODUCER_BLOCKDEVICE == INTERNAL_IPC_PRODUCER_BLOCKDEVICE_ONLY_ISX021)
...
#endif
#endif
#if (INTERNAL_IPC_PRODUCER_BLOCKDEVICE == INTERNAL_IPC_PRODUCER_BLOCKDEVICE_ONLY_X8B)
	/*
	* 1 mean use mailbox mode.
	*/
	_deviceopenpara.Init(HW_NVMEDIA_APPTYPE_IPC_PRODUCER,
...
hw_ret_s32 HWNvmediaIpcProducerAContext::GetRegDataCbType_OutputType(HW_VIDEO_REGDATACB_TYPE i_regdatacbtype, 
	HW_VIDEO_INPUT_TYPE inputType, HWNvmediaEventHandlerRegDataCbConfig* o_pcbconfig)
{
#if ((INTERNAL_IPC_PRODUCER_BLOCKDEVICE == INTERNAL_IPC_PRODUCER_BLOCKDEVICE_ONLY_IMX728) || (INTERNAL_IPC_PRODUCER_BLOCKDEVICE == INTERNAL_IPC_PRODUCER_BLOCKDEVICE_ONLY_X8B))
