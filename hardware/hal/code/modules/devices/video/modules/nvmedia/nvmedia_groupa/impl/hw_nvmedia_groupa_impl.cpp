...
#define INTERNAL_GROUPA_BLOCKDEVICE_ONLY_IMX728			0
#define INTERNAL_GROUPA_BLOCKDEVICE_ONLY_ISX021			1
#define INTERNAL_GROUPA_BLOCKDEVICE_ONLY_X8B			2

#define INTERNAL_GROUPA_BLOCKDEVICE						INTERNAL_GROUPA_BLOCKDEVICE_ONLY_IMX728
...
HWNvmediaGroupaContext::HWNvmediaGroupaContext(struct hw_video_t* i_pvideo)
	: HWNvmediaSingleProcessContext(i_pvideo)
{
#if (INTERNAL_GROUPA_BLOCKDEVICE == INTERNAL_GROUPA_BLOCKDEVICE_ONLY_IMX728)
...
#endif
#endif
#if (INTERNAL_GROUPA_BLOCKDEVICE == INTERNAL_GROUPA_BLOCKDEVICE_ONLY_ISX021)
...
#endif
#endif
#if (INTERNAL_GROUPA_BLOCKDEVICE == INTERNAL_GROUPA_BLOCKDEVICE_ONLY_X8B)
	/*
	* 1 mean use mailbox mode.
	*/
	_deviceopenpara.Init(HW_NVMEDIA_APPTYPE_SINGLE_PROCESS,
...
hw_ret_s32 HWNvmediaGroupaContext::GetRegDataCbType_OutputType(HW_VIDEO_REGDATACB_TYPE i_regdatacbtype, 
