#ifndef HW_NVMEDIA_MULTIIPC_CONSUMER_CUDA_IMPL_H
#define HW_NVMEDIA_MULTIIPC_CONSUMER_CUDA_IMPL_H

#include "hw_nvmedia_common_impl.h"
#include "hw_nvmedia_multiipc_consumer_cuda.h"

/*
* Groupa context.
* The instance of the class is stored in priv of hw_video_t.
*/
class HWNvmediaMultiIpcConsumerCudaContext : public HWNvmediaIpcConsumerContext
{
private:
	HWNvmediaMultiIpcConsumerCudaContext();
public:
	HWNvmediaMultiIpcConsumerCudaContext(struct hw_video_t* i_pvideo);
	~HWNvmediaMultiIpcConsumerCudaContext()
	{
...
class HWNvmediaMultiIpcConsumerCudaEnv
{
public:
	HWNvmediaMultiIpcConsumerCudaEnv()
	{
		/*
...
public:
	...
	*/
	HWNvmediaMultiIpcConsumerCudaContext*			pcontext = NULL;
	/*
...
#endif // HW_NVMEDIA_MULTIIPC_CONSUMER_CUDA_IMPL_H
