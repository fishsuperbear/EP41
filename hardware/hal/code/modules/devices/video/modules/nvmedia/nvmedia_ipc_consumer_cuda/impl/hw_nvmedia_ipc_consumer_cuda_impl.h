#ifndef HW_NVMEDIA_IPC_CONSUMER_CUDA_IMPL_H
#define HW_NVMEDIA_IPC_CONSUMER_CUDA_IMPL_H
...
*/
class HWNvmediaIpcConsumerCudaContext : public HWNvmediaIpcConsumerContext
{
private:
	HWNvmediaIpcConsumerCudaContext();
public:
	HWNvmediaIpcConsumerCudaContext(struct hw_video_t* i_pvideo);
	~HWNvmediaIpcConsumerCudaContext()
	{
...
class HWNvmediaIpcConsumerCudaEnv
{
public:
	HWNvmediaIpcConsumerCudaEnv()
	{
		/*
...
public:
	...
	*/
	HWNvmediaIpcConsumerCudaContext*			pcontext = NULL;
	/*
...
#endif // HW_NVMEDIA_IPC_CONSUMER_CUDA_IMPL_H
