#ifndef HW_NVMEDIA_GROUPA_IMPL_H
#define HW_NVMEDIA_GROUPA_IMPL_H
...
*/
class HWNvmediaGroupaContext : public HWNvmediaSingleProcessContext
{
private:
	HWNvmediaGroupaContext();
public:
	HWNvmediaGroupaContext(struct hw_video_t* i_pvideo);
	~HWNvmediaGroupaContext()
	{
...
public:
	...
	*/
	HWNvmediaGroupaContext*			pcontext = NULL;
	/*
