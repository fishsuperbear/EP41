...
HWNvmediaMultiGroupContext::HWNvmediaMultiGroupContext(struct hw_video_t* i_pvideo)
	: HWNvmediaSingleProcessContext(i_pvideo)
{
	...
	*/
	...
	_deviceopenpara.Init(HW_NVMEDIA_APPTYPE_SINGLE_PROCESS,
		"XPC_MULTIPLE_CAMERA",
		"0x0011 0x1111 0x1111", 1, "/usr/share/camera/");
#endif
	...
	_deviceopenpara.Init(HW_NVMEDIA_APPTYPE_SINGLE_PROCESS,
        ...
        //desay
		"XPC_MULTIPLE_CAMERA",
		/* "0x0001 0 0", 1, "/usr/share/camera/"); */
		"0x1011 0x1111 0x1111", 1, "/usr/share/camera/");
#endif
}

hw_ret_s32 HWNvmediaMultiGroupContext::GetRegDataCbType_OutputType(HW_VIDEO_REGDATACB_TYPE i_regdatacbtype, 
