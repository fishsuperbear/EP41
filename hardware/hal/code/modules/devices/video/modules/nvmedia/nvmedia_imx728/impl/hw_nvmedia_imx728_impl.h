#ifndef HW_NVMEDIA_IMX728_IMPL_H
#define HW_NVMEDIA_IMX728_IMPL_H
...
*/
class HWNvmediaImx728Context : public HWNvmediaSingleProcessContext
{
private:
	HWNvmediaImx728Context();
public:
	HWNvmediaImx728Context(struct hw_video_t* i_pvideo);
	~HWNvmediaImx728Context()
	{
...
public:
	...
	*/
	HWNvmediaImx728Context*			pcontext = NULL;
	/*
