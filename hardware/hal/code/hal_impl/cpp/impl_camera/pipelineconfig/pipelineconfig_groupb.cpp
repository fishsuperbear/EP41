...
#if 0
static void handle_yuv422_buffer_groupb(struct hw_video_bufferinfo_t* i_pbufferinfo)
{
#if 0
...
static struct hw_video_blockspipelineconfig_t _pipelineconfig_groupb =
{
    .parrayblock =
    {
        [0] =
                        ...
                        */
                        .parraydatacbs =
                        {
                            [0] =
                            {
                                ...
                                .cb = handle_yuv422_buffer_groupb,
                                .bsynccb = 1,
...
{
    *i_ppipelineconfig = _pipelineconfig_groupb;
}
