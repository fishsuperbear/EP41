...
/**
 * @namespace framework.parameter
 */
namespace netaos {
namespace framework {

using netaos::framework::proto::Param;
using netaos::framework::proto::ParamType;

/**
 * @class Parameter
 * @brief A `Parameter` holds an netaos::framework::proto::Param,
...
class Parameter {
 public:
  ...
  /**
   * @brief Parse a framework::proto::Param object to
   * framework::parameter::Parameter object
   * @param param The framework::proto::Param object parse from
  ...
  /**
   * @brief Parse a framework::parameter::Parameter object to
   * framework::proto::Param object
   * @return The target framework::proto::Param object
   */
  Param ToProtoParam() const;

  /**
   * @brief Get the framework:parameter::ParamType of this object
   * @return result framework:parameter::ParameterType
   */
