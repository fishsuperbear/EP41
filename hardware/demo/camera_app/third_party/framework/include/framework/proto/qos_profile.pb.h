...
PROTOBUF_NAMESPACE_OPEN
template<> ::netaos::framework::proto::QosProfile* Arena::CreateMaybeMessage<::netaos::framework::proto::QosProfile>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace netaos {
namespace framework {
namespace proto {
...
class QosProfile PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:netaos.framework.proto.QosProfile) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "netaos.framework.proto.QosProfile";
  }
  protected:
  ...
  // optional .netaos.framework.proto.QosHistoryPolicy history = 1 [default = HISTORY_KEEP_LAST];
  bool has_history() const;
  private:
  bool _internal_has_history() const;
  public:
  void clear_history();
  ::netaos::framework::proto::QosHistoryPolicy history() const;
  void set_history(::netaos::framework::proto::QosHistoryPolicy value);
  private:
  ::netaos::framework::proto::QosHistoryPolicy _internal_history() const;
  void _internal_set_history(::netaos::framework::proto::QosHistoryPolicy value);
  public:
  ...
  // optional .netaos.framework.proto.QosReliabilityPolicy reliability = 4 [default = RELIABILITY_RELIABLE];
  bool has_reliability() const;
  private:
  bool _internal_has_reliability() const;
  public:
  void clear_reliability();
  ::netaos::framework::proto::QosReliabilityPolicy reliability() const;
  void set_reliability(::netaos::framework::proto::QosReliabilityPolicy value);
  private:
  ::netaos::framework::proto::QosReliabilityPolicy _internal_reliability() const;
  void _internal_set_reliability(::netaos::framework::proto::QosReliabilityPolicy value);
  public:

  // optional .netaos.framework.proto.QosDurabilityPolicy durability = 5 [default = DURABILITY_VOLATILE];
  bool has_durability() const;
  private:
  bool _internal_has_durability() const;
  public:
  void clear_durability();
  ::netaos::framework::proto::QosDurabilityPolicy durability() const;
  void set_durability(::netaos::framework::proto::QosDurabilityPolicy value);
  private:
  ::netaos::framework::proto::QosDurabilityPolicy _internal_durability() const;
  void _internal_set_durability(::netaos::framework::proto::QosDurabilityPolicy value);
  public:

  // @@protoc_insertion_point(class_scope:netaos.framework.proto.QosProfile)
 private:
  class _Internal;
...
inline ::netaos::framework::proto::QosHistoryPolicy QosProfile::_internal_history() const {
  return static_cast< ::netaos::framework::proto::QosHistoryPolicy >(history_);
}
inline ::netaos::framework::proto::QosHistoryPolicy QosProfile::history() const {
  // @@protoc_insertion_point(field_get:netaos.framework.proto.QosProfile.history)
  return _internal_history();
}
inline void QosProfile::_internal_set_history(::netaos::framework::proto::QosHistoryPolicy value) {
  assert(::netaos::framework::proto::QosHistoryPolicy_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  history_ = value;
}
inline void QosProfile::set_history(::netaos::framework::proto::QosHistoryPolicy value) {
  _internal_set_history(value);
  // @@protoc_insertion_point(field_set:netaos.framework.proto.QosProfile.history)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 QosProfile::depth() const {
  // @@protoc_insertion_point(field_get:netaos.framework.proto.QosProfile.depth)
...
inline void QosProfile::set_depth(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:netaos.framework.proto.QosProfile.depth)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 QosProfile::mps() const {
  // @@protoc_insertion_point(field_get:netaos.framework.proto.QosProfile.mps)
...
inline void QosProfile::set_mps(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:netaos.framework.proto.QosProfile.mps)
}
...
inline ::netaos::framework::proto::QosReliabilityPolicy QosProfile::_internal_reliability() const {
  return static_cast< ::netaos::framework::proto::QosReliabilityPolicy >(reliability_);
}
inline ::netaos::framework::proto::QosReliabilityPolicy QosProfile::reliability() const {
  // @@protoc_insertion_point(field_get:netaos.framework.proto.QosProfile.reliability)
  return _internal_reliability();
}
inline void QosProfile::_internal_set_reliability(::netaos::framework::proto::QosReliabilityPolicy value) {
  assert(::netaos::framework::proto::QosReliabilityPolicy_IsValid(value));
  _has_bits_[0] |= 0x00000008u;
  reliability_ = value;
}
inline void QosProfile::set_reliability(::netaos::framework::proto::QosReliabilityPolicy value) {
  _internal_set_reliability(value);
  // @@protoc_insertion_point(field_set:netaos.framework.proto.QosProfile.reliability)
}
...
inline ::netaos::framework::proto::QosDurabilityPolicy QosProfile::_internal_durability() const {
  return static_cast< ::netaos::framework::proto::QosDurabilityPolicy >(durability_);
}
inline ::netaos::framework::proto::QosDurabilityPolicy QosProfile::durability() const {
  // @@protoc_insertion_point(field_get:netaos.framework.proto.QosProfile.durability)
  return _internal_durability();
}
inline void QosProfile::_internal_set_durability(::netaos::framework::proto::QosDurabilityPolicy value) {
  assert(::netaos::framework::proto::QosDurabilityPolicy_IsValid(value));
  _has_bits_[0] |= 0x00000010u;
  durability_ = value;
}
inline void QosProfile::set_durability(::netaos::framework::proto::QosDurabilityPolicy value) {
  _internal_set_durability(value);
  // @@protoc_insertion_point(field_set:netaos.framework.proto.QosProfile.durability)
}
...
template <> struct is_proto_enum< ::netaos::framework::proto::QosHistoryPolicy> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::netaos::framework::proto::QosHistoryPolicy>() {
  return ::netaos::framework::proto::QosHistoryPolicy_descriptor();
}
template <> struct is_proto_enum< ::netaos::framework::proto::QosReliabilityPolicy> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::netaos::framework::proto::QosReliabilityPolicy>() {
  return ::netaos::framework::proto::QosReliabilityPolicy_descriptor();
}
template <> struct is_proto_enum< ::netaos::framework::proto::QosDurabilityPolicy> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::netaos::framework::proto::QosDurabilityPolicy>() {
  return ::netaos::framework::proto::QosDurabilityPolicy_descriptor();
}
