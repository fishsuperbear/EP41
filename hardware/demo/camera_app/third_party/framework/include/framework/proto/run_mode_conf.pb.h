...
PROTOBUF_NAMESPACE_OPEN
template<> ::netaos::framework::proto::RunModeConf* Arena::CreateMaybeMessage<::netaos::framework::proto::RunModeConf>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace netaos {
namespace framework {
namespace proto {
...
class RunModeConf PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:netaos.framework.proto.RunModeConf) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "netaos.framework.proto.RunModeConf";
  }
  protected:
  ...
  // optional .netaos.framework.proto.RunMode run_mode = 1 [default = MODE_REALITY];
  bool has_run_mode() const;
  private:
  bool _internal_has_run_mode() const;
  public:
  void clear_run_mode();
  ::netaos::framework::proto::RunMode run_mode() const;
  void set_run_mode(::netaos::framework::proto::RunMode value);
  private:
  ::netaos::framework::proto::RunMode _internal_run_mode() const;
  void _internal_set_run_mode(::netaos::framework::proto::RunMode value);
  public:

  // optional .netaos.framework.proto.ClockMode clock_mode = 2 [default = MODE_CYBER];
  bool has_clock_mode() const;
  private:
  bool _internal_has_clock_mode() const;
  public:
  void clear_clock_mode();
  ::netaos::framework::proto::ClockMode clock_mode() const;
  void set_clock_mode(::netaos::framework::proto::ClockMode value);
  private:
  ::netaos::framework::proto::ClockMode _internal_clock_mode() const;
  void _internal_set_clock_mode(::netaos::framework::proto::ClockMode value);
  public:

  // @@protoc_insertion_point(class_scope:netaos.framework.proto.RunModeConf)
 private:
  class _Internal;
...
inline ::netaos::framework::proto::RunMode RunModeConf::_internal_run_mode() const {
  return static_cast< ::netaos::framework::proto::RunMode >(run_mode_);
}
inline ::netaos::framework::proto::RunMode RunModeConf::run_mode() const {
  // @@protoc_insertion_point(field_get:netaos.framework.proto.RunModeConf.run_mode)
  return _internal_run_mode();
}
inline void RunModeConf::_internal_set_run_mode(::netaos::framework::proto::RunMode value) {
  assert(::netaos::framework::proto::RunMode_IsValid(value));
  _has_bits_[0] |= 0x00000001u;
  run_mode_ = value;
}
inline void RunModeConf::set_run_mode(::netaos::framework::proto::RunMode value) {
  _internal_set_run_mode(value);
  // @@protoc_insertion_point(field_set:netaos.framework.proto.RunModeConf.run_mode)
}
...
inline ::netaos::framework::proto::ClockMode RunModeConf::_internal_clock_mode() const {
  return static_cast< ::netaos::framework::proto::ClockMode >(clock_mode_);
}
inline ::netaos::framework::proto::ClockMode RunModeConf::clock_mode() const {
  // @@protoc_insertion_point(field_get:netaos.framework.proto.RunModeConf.clock_mode)
  return _internal_clock_mode();
}
inline void RunModeConf::_internal_set_clock_mode(::netaos::framework::proto::ClockMode value) {
  assert(::netaos::framework::proto::ClockMode_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  clock_mode_ = value;
}
inline void RunModeConf::set_clock_mode(::netaos::framework::proto::ClockMode value) {
  _internal_set_clock_mode(value);
  // @@protoc_insertion_point(field_set:netaos.framework.proto.RunModeConf.clock_mode)
}
...
template <> struct is_proto_enum< ::netaos::framework::proto::RunMode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::netaos::framework::proto::RunMode>() {
  return ::netaos::framework::proto::RunMode_descriptor();
}
template <> struct is_proto_enum< ::netaos::framework::proto::ClockMode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::netaos::framework::proto::ClockMode>() {
  return ::netaos::framework::proto::ClockMode_descriptor();
}
