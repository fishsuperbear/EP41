...
#include "framework/tools/framework_monitor/general_message_base.h"
 ...
 private:
  explicit GeneralChannelMessage(const std::string& node_name,
      ...
      : GeneralMessageBase(parent),
        ...
        message_type_(),
        frame_counter_(0),
        last_time_(netaos::framework::Time::MonoTime()),
  ...
  void UpdateRawMessage(
      const std::shared_ptr<netaos::framework::message::RawMessage>& raw_msg) {
    set_has_message_come(true);
    msg_time_ = netaos::framework::Time::MonoTime();
    ++frame_counter_;
  ...
  std::shared_ptr<netaos::framework::message::RawMessage> CopyMsgPtr(void) const {
  ...
  netaos::framework::Time last_time_;
  netaos::framework::Time msg_time_;
  netaos::framework::Time time_last_calc_ = netaos::framework::Time::MonoTime();

  std::unique_ptr<netaos::framework::Node> channel_node_;
  ...
  std::shared_ptr<netaos::framework::message::RawMessage> channel_message_;
  std::shared_ptr<netaos::framework::Reader<netaos::framework::message::RawMessage>>
      channel_reader_;
