...
#include "framework/service/client_base.h"
...
#ifdef ENABLE_TRACE
  TRACE_ENTRY_EXT(FrameworkTraceModule::CLIENTSENDREQUEST, m_context);
  TRACE_SEND_MSG(request);
  TRACE_SYS_PERF();
#endif
