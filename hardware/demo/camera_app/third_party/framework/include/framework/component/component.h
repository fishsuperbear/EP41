 ...
 * Init() & Proc(...), They are picked up by the netaos framework. There are 4
 ...
 * be called. They are called by the netaos framework.
 *
 */
...
#define CYBER_REGISTER_COMPONENT(name) \
  CLASS_LOADER_REGISTER_CLASS(name, netaos::framework::ComponentBase)
