...
#define NVOS_SLOG_CODE_NVVIDEO_IEP  (NVOS_LOG_CODE_START + 78)
...
#define NVOS_SLOG_CODE_NVRMSYNC  (NVOS_LOG_CODE_START + 81)
/* @brief slog code for nvrm_gpu */
#define NVOS_SLOG_CODE_NVRMGPU (NVOS_LOG_CODE_START + 82)
/* @brief slog code for nvrm_chip */
#define NVOS_SLOG_CODE_NVRMCHIP (NVOS_LOG_CODE_START + 83)
/* @brief slog code for nvrm_surface */
#define NVOS_SLOG_CODE_NVRMSURFACE (NVOS_LOG_CODE_START + 84)
