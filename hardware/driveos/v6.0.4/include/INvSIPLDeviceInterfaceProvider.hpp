...
public:
     ...
     * but should be checked for nullptr before use.
     *
     * @param[in] interfaceId   Unique identifier for the interface to retrieve
     * @retval                  Interface* matching the provided ID;
     *                          nullptr if none found or not implemented.
     */
