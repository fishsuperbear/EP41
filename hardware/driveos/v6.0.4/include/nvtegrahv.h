 ...
 */
typedef int32_t (*PfnNvHvGetSysinfoAddr)(uint64_t *addr);
#if (NV_IS_SAFETY == 0)
/**
 ...
 * This API requests Virtuaization system to get Hypervisor sysinfo IPA.
 *
 * @param[out] addr IPA to HV system info. Memory for this shall be allocated by calling function/process.
 *
 * @return
 * 		EOK Success\n
 * 		ENODEV Failed to open NvHv device node\n
 ...
 */
int32_t NvHvGetSysinfoAddr(uint64_t *addr);
