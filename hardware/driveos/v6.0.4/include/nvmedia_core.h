...
NvMediaDeviceCreate(
    void
)NVM_DEPRECATED_MSG("Removed in future release");
 ...
 *
 * <b> Version 1.15 </b> August 20, 2021
 * - Update doxygen comments for All APIs to have Thread safety information and API Group information
 *
 * <b> Version 1.16 </b> December 9, 2021
 * - Added patch member to version information for future compatibility
 *
 * <b> Version 1.17 </b> May 27, 2022
 * - Typedef'd NvMediaDevice as void to aid deprecation
 *
 * <b> Version 1.18 </b> May 30, 2022
 * - Removed Version API, removed release and core version,
 *   marked Device Create and Destroy API as deprecated
 */
